...
=== gift ===
{
  ...
  "best": {
    "id": "${finalBest.id}",
    "reason": "請根據以下原則給出真正有說服力的建議： 
      1. 根據茶款的定位：例如高山茶更常見、白茶優雅、烏龍茶大眾易接受。
      2. 根據使用者語氣猜測用途：送長輩、送朋友、送同事、正式禮、輕禮。
      3. 避免每次推薦同一款茶。若使用者沒有明確需求，請從產品列表中選出「最適合送禮」的茶（如：梨山、阿里山、東方美人、桂花烏龍、茉莉窨茶）。
      4. 若使用者提到預算、場合、對象，必須根據該條件重新挑選。
      5. 茉莉花茶不是唯一答案，只有在“使用者明確偏好花香、入門”時才優先推薦。
    "
  }
}
